...
* [senate_presidential_support.csv](senate_presidential_support.csv): Member-year level presidential support scores for Senate members.  
...
pres_score <- function() {
  ...
  score <- dat |>
    ...
    summarize(
      ...
      .by = c(congress, chamber, year, icpsr, bioname, state_abbrev, district_code)
    )
}
...
summary_scores <- support_scores |>
  ...
  summarize(
    ...
    .by = c(chamber, icpsr, congress, year)
  ) |>
  summarize(
