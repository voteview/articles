---
title: "Attendence of Senators and House Members Running for President"
author: "Jeff Lewis"
...
<font color="`r color[1]`">green line</font> shows the average rate of participation across the all of these presidential candidates.  The <font color="`r color[3]`">blue line</font> shows the average of Barack Obama's and Hillary Clinton's rates of participation in the corresponding months of the 2008 presidential election cycle.  The <font color="`r color[2]`">orange line</font> shows the average of Ted Cruz's and Marco Rubio's participation rates in the corresponding months of the 2016 presidental election cycle.   


```{r download data, message=F, warning=F, include=FALSE}
stack_csvs <- function(csvs) {
  lapply(csvs, read_csv) %>%
     bind_rows()
}
