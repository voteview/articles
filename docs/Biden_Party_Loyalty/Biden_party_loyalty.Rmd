...
rollcalls <- read_csv("https://voteview.com/static/data/out/rollcalls/Sall_rollcalls.csv")
members <- read_csv("https://voteview.com/static/data/out/members/Sall_members.csv")
...
```
we find that he voted with the Democrats `r sprintf("%3.1f", 100*biden$party_loyalty)` percent of the time making him the `r ordinal(iden$rank)` most loyal of the `r NROW(all)` Democratic senators with whom he served. 
