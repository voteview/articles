...
```
we find that he voted with the Democrats `{r} sprintf("%3.1f", 100*biden$party_loyalty)` percent of the time making him the `{r} biden$rank` most loyal of the `{r} NROW(all)` Democratic senators with whom he served. 
